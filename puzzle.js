...
знания1.добавить(new Эквивалентность(new И(БЛжец, АЛжец), АРыцарь))
// Добавьте
...
знания2.добавить(new Эквивалентность( new Или(new И(БЛжец, АЛжец), new И(БРыцарь, АРыцарь)), АРыцарь))
знания2.добавить(new Эквивалентность(new Или(new И(БРыцарь, АЛжец), new И(БЛжец, АРыцарь)), БРыцарь))
// Задача 3
